...
const rawData = [
  ...
  { date: '2024 - Present', title: 'Admin Developer', org: 'Tidal Tasks AI', hours: '200+ hrs', description: 'Building admin systems and features for an AI-powered task management startup.', tags: ['React', 'TypeScript', 'Firebase', 'Gemini API'], color: 'orange' },
  { date: '2024', title: 'Soil Testing Intern', org: 'University of Waterloo', hours: '100+ hrs', description: 'Research experience in soil analysis, stress-strain plotting, and MATLAB data visualization.', tags: ['MATLAB', 'Data Analysis', 'Research'], color: 'orange' },
